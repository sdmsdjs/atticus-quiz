...
</html>`},k=(t,n,e)=>{const i=new Blob([t],{type:e}),o=URL.createObjectURL(i),r=document.createElement("a");r.href=o,r.download=f(n),document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(o)},C=(t,n=`${u(t)}.html`)=>{const e=n.replace(/\.html?$/i,"");k(g(t,e),n,"text/html;charset=utf-8")},T=(t,n=u(t))=>{const e=new Blob([g(t,n)],{type:"text/html;charset=utf-8"});return URL.createObjectURL(e)};export{g as buildHtmlDocument,v as buildHtmlSlides,T as createHtmlPreviewUrl,C as exportToHtml};
